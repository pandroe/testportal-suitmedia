        ...
        child: Column(
          ...
          children: [
           Column(
            ...
            children: [
              Text('Welcome', style: TextStyle(fontSize: Constants.fontSmall, fontWeight: FontWeight.w400),),
              Text('John Doe', style: TextStyle(fontSize: Constants.fontSemiBig, fontWeight: FontWeight.bold),),
            ],
           ),
            Column(
            children: [
              Text('Selected User Name', style: TextStyle(fontSize: Constants.fontExtraBig, fontWeight: FontWeight.bold),),
            ],
           ),
           ChooseAUserButton(onPressed: () {
